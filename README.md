...
This course provides a mathematically grounded introduction to statistical learning, organized around a small set of unifying principles rather than a collection of disconnected algorithms. Beginning with probability, information entropy, multivariate Gaussian distributions, and conditional expectation, it develops regression, Bayesian inference, Kalman filtering, Gaussian process regression, Gaussian mixture clustering, dimensionality reduction, and logistic/softmax classification as applications of these underlying ideas. A distinctive feature of the course is its emphasis on revealing the mathematical connections between methods—for example, conditional expectation as a common foundation for estimation and prediction, Bayesian conditional updating as a basis for probabilistic clustering, and conditional maximum-entropy inference as a route to logistic classification. Measure-theoretic foundations are combined with derivations, computational examples, interactive visualizations, assignments, and applications, providing a bridge between rigorous statistical reasoning and practical statistical learning.
...
- [Assignments/Sample Answers](#assignmentssample-answers) — Worked solutions for assignments across the repo topics (useful reference answers):
